 ...
 */
abstract class modModifiedHelper
{
	/**
	...
	public static function getList($params)
	{
		...
		$model->setState('list.select', 'a.id, a.title, a.checked_out, a.checked_out_time, ' .
				' a.access, a.created, a.created_by, a.created_by_alias, a.featured, a.state, a.modified, a.modified_by');
	...
	public static function getTitle($params)
	{
		...
		return JText::plural('MOD_MODIFIED_TITLE'.$type.($catid ? "_CATEGORY" : '').($who!='0' ? "_$who" : ''), (int)$params->get('count'), $title);
	}
}
